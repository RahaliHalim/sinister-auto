...
public class DroolsConfiguration {
    ...
    private static final String RULES_PATH = "com/gaconnecte/auxilium/drools/";
    private static final String RULES_PATH_QUOTATION_FILE = "rule.drl";
    ...
    public KieFileSystem kieFileSystem() throws IOException {
        ...
        for (Resource file : getRuleFiles()) {
            ...
            System.out.println("File [" + file.getFilename() + "] added");
        }        
