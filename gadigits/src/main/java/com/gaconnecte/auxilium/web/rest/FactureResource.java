...
public class FactureResource {
    ...
    @GetMapping("/factures")
    @Timed
    public ResponseEntity<List<FactureDTO>> getAllFactures(@ApiParam Pageable pageable) {
    ...
    @Timed
    public ResponseEntity<List<FactureDTO>> searchFactures(@RequestParam String query, @ApiParam Pageable pageable) {
