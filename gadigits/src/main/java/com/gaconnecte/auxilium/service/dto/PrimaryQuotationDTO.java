...
public class PrimaryQuotationDTO implements Serializable {
	...
	/*
	 * public void addToDetailsPieces(DetailsPiecesDTO piece) {
	 * piece.setQuotation((QuotationDTO)this); this.listPieces.add(piece); }
	 */
