...
public interface HistoryPartnerRulesMapper extends EntityMapper <HistoryPartnerRulesDTO, HistoryPartnerRules>{
    ...
    HistoryPartnerRulesDTO toDto(HistoryPartnerRules historyPartnerRules);
    ...
    HistoryPartnerRules toEntity(HistoryPartnerRulesDTO historyPartnerRulesDTO);

    default HistoryPartnerRules fromId(Long id) {
        if (id == null) {
            return null;
        }
        HistoryPartnerRules historyPartnerRules = new HistoryPartnerRules();
        historyPartnerRules.setId(id);
        return historyPartnerRules;
    }
}
