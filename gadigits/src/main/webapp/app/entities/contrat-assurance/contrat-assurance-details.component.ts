...
@Component({
    selector: 'jhi-contrat-assurance-details',
    templateUrl: './contrat-assurance-details.component.html'
})
export class ContratAssuranceDetailsComponent implements OnInit {
