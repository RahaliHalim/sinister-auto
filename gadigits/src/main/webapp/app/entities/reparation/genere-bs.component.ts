...
@Component( {
    ...
    templateUrl: './genere-bs.component.html'
} )
export class GenerationBSComponent implements OnInit, OnDestroy {
    currentAccount: any;
    ...
    loadAll() {
        ...
        this.prestationPECService.queryReparateur(QuoteStatus.BS_STATUS_VALIDATED_BY_GA,4).subscribe(
            ( res: ResponseWrapper ) => {
