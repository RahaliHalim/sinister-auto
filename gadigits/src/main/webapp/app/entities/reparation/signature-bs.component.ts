...
@Component( {
    ...
    templateUrl: './signature-bs.component.html'
} )
export class SignatureBSComponent implements OnInit, OnDestroy {
    currentAccount: any;
    ...
    loadAll() {
        this.prestationPECService.queryReparateur(QuoteStatus.BS_STATUS_GENERATED_BY_REPAIR,2).subscribe(
            ( res: ResponseWrapper ) => {
