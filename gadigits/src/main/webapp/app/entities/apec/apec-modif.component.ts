...
@Component({
    selector: 'jhi-apec',
    templateUrl: './apec-modif.component.html'
})
export class ApecModifComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        ...
        this.apecService.queryByStatus(EtatAccord.ACC_FAVORABLE_AVEC_MODIF).subscribe(
    ...
    private onSuccess(data, headers) {
        ...
        for (let i = 0; i < this.apecs.length; i++) {
            if (this.apecs[i].sinisterPec.stepId == 104) {
