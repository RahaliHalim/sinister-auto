...
@Component({
    selector: 'jhi-apec',
    templateUrl: './apec.component.html'
})
export class ApecComponent implements OnInit, OnDestroy {
...
currentAccount: any;
    ...
    transition() {
        this.router.navigate(['/apec'], {queryParams:
            {
                page: this.page,
                size: this.itemsPerPage,
