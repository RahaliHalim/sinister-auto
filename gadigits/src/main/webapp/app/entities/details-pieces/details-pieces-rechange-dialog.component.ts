...
@Component({
    selector: 'jhi-details-pieces-dialog',
    templateUrl: './details-pieces-rechange-dialog.component.html'
})
export class DetailsPiecesDialogComponent implements OnInit {

    @Input() detailsPieces: DetailsPieces[] = [];
    isSaving: boolean;
    ...
    ngOnInit() {
        ...
        this.pieceService.getPiecesByType(1)
    ...
    addNew() {
        this.detailsPieces.push(<DetailsPieces>{controlIndex: this.iRow});
        this.rowValidateForm(this.iRow++, 'add');
    }
    removeRow(index) {
        //let controlIndex = this.detailsPieces[index].controlIndex-1;
...
export class DetailsPiecesPopupComponent implements OnInit, OnDestroy {
        ...
        this.routeSub = this.route.params.subscribe((params) => {
            if ( params['id'] ) {
                this.detailsPiecesPopupService
                    .open(DetailsPiecesDialogComponent as Component, params['id']);
            } else {
                this.detailsPiecesPopupService
                    .open(DetailsPiecesDialogComponent as Component);
            }
        });
    }
