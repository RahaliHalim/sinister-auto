...
@Component({
    selector: 'jhi-details-pieces-fourniture-dialog',
    templateUrl: './details-pieces-fourniture-dialog.component.html'
})
export class DetailsPiecesFournitureDialogComponent implements OnInit {

    @Input() detailsPiecesFourniture: DetailsPieces[] = [];
    isSaving: boolean;
    ...
    ngOnInit() {
        ...
        this.pieceService.getPiecesByType(3)
    ...
    addNew() {
      this.detailsPiecesFourniture.push(<DetailsPieces>{controlIndex: this.iRow});
...
export class DetailsPiecesFourniturePopupComponent implements OnInit, OnDestroy {
        ...
        this.routeSub = this.route.params.subscribe((params) => {
            if ( params['id'] ) {
                this.detailsPiecesPopupService
                    .open(DetailsPiecesFournitureDialogComponent as Component, params['id']);
            } else {
                this.detailsPiecesPopupService
                    .open(DetailsPiecesFournitureDialogComponent as Component);
            }
        });
    }
