...
@Component({
    selector: 'jhi-sinister-pec-change-status',
    templateUrl: 'sinister-pec-change-status.component.html'

})
export class SinisterPecChangeStatus implements OnInit, OnDestroy {
    sinister: Sinister;
