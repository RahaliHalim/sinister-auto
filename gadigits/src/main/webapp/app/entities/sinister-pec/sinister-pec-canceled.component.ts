...
@Component({
    selector: 'jhi-sinister-pec-canceled',
    templateUrl: 'sinister-pec-canceled.component.html'

})
export class SinisterPecCanceled implements OnInit, OnDestroy {
    sinister: Sinister;
    ...
    loadAll() {
        ...
        this.principal.identity().then((account) => {
            ...
            this.userExtraService.findFunctionnalityEntityByUser(85, this.currentAccount.id).subscribe(res => {
                ...
                this.sinisterPecService.findPrestCanceledAprouvedAndAprouvedWithModif(this.currentAccount.id).subscribe((res) => {
