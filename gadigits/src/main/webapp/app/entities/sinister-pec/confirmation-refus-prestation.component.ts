...
@Component({
    selector: 'jhi-resfus-prestation',
    templateUrl: './confirmation-refus-prestation.component.html'
})
export class ConfirmationRefusPrestationComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        ...
        this.principal.identity().then((account) => {
            ...
            this.userExtraService.findFunctionnalityEntityByUser(100, this.currentAccount.id).subscribe(res => {
                ...
                this.viewSinisterPecService.queryToConfirmRefusedPec(this.currentAccount.id).subscribe((res) => {
