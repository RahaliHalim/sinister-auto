...
@Component({
    selector: 'jhi-sinister-pec-canceled-refused',
    templateUrl: 'sinister-pec-canceled-refused.component.html'

})
export class SinisterPecCanceledAndRefused implements OnInit, OnDestroy {
    sinister: Sinister;
    ...
    loadAll() {
        this.sinisterPecService.findViewPrestAccRefusedAndCanceledAndAprouvedAndAprouvedWithModif(this.currentAccount.id).subscribe((res) => {
