...
@Component({
  selector: 'jhi-verification-originals-printed',
  templateUrl: './verification-originals-printed.component.html',
})

export class VerificationOriginalsPrintedComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        ...
        this.principal.identity().then((account) => {
            ...
            this.userExtraService.findFunctionnalityEntityByUser(47, this.currentAccount.id).subscribe(res => {
                ...
                this.sinisterPecService.findAllPrestationPECOriginalsPrinted(this.currentAccount.id).subscribe((res) => {
