...
@Component({
    selector: 'jhi-sinister-pec-modification-status',
    templateUrl: 'sinister-pec-modification-status.component.html'

})
export class SinisterPecModificationStatus implements OnInit, OnDestroy {
    sinister: Sinister;
    ...
    loadAll() {
        ...
        this.principal.identity().then((account) => {
            ...
            this.userExtraService.findFunctionnalityEntityByUser(85, this.currentAccount.id).subscribe(res => {
                ...
                this.sinisterPecService.findPrestAccWithChangeStatusAprouvedAndAprouvedWithModif(this.currentAccount.id).subscribe((res) => {
