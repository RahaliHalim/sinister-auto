...
@Component({
    ...
    templateUrl: './sinister-pec-refused.component.html'

})
export class SinisterPecRefused implements OnInit, OnDestroy {
    sinister: Sinister;
    ...
    loadAll() {
        ...
        this.principal.identity().then((account) => {
            ...
            this.userExtraService.findFunctionnalityEntityByUser(85, this.currentAccount.id).subscribe(res => {
                ...
                this.sinisterPecService.findPrestViewRefusedAprouvedAndAprouvedWithModif(this.currentAccount.id).subscribe((res) => {
