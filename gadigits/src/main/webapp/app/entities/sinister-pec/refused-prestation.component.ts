...
@Component({
    selector: 'jhi-refused-prestation',
    templateUrl: './refused-prestation.component.html'
})
export class RefusPrestationComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        ...
        this.principal.identity().then((account) => {
            ...
            this.userExtraService.findFunctionnalityEntityByUser(100, this.currentAccount.id).subscribe(res => {
                ...
                this.sinisterPecService.queryToRefusedPec(this.currentAccount.id).subscribe((res) => {
