...
@Component({
    selector: 'jhi-sinister-pec-reserves-lifted',
    templateUrl: 'sinister-pec-reserves-lifted.component.html'

})
export class SinisterPecReservesLifted implements OnInit, OnDestroy {
    sinister: Sinister;
    ...
    loadAll() {
        this.principal.identity().then((account) => {
            ...
            this.userExtraService.findFunctionnalityEntityByUser(85, this.currentAccount.id).subscribe(res => {
                ...
                this.sinisterPecService.findPrestAccWithResrveAprouvedAndAprouvedWithModif(this.currentAccount.id).subscribe((res) => {
