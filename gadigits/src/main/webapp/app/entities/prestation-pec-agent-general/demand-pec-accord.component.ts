...
@Component({
    selector: "jhi-demand-pec-accord",
    templateUrl: "./demand-pec-accord.component.html"
})
export class DemandPecAccordComponent implements OnInit, OnDestroy {
    currentAccount: any;
    demands: DemandPec[];
    error: any;
    success: any;
     ...
     */
    ngOnInit() {
        console.log("___________________________________________________0");
        this.dtOptions = {
            pagingType: 'full_numbers',
            pageLength: 10,
            retrieve: true,
            // Declare the use of the extension in the dom parameter
            dom: '<"row"<"col-sm-6"l><"col-sm-6"f>>t<"row"<"col-sm-6"B><"col-sm-6 text-align-right"p>>',
    ...
    loadAll() {
        this.demandPecService.findAccordDemands().subscribe(
            (res: ResponseWrapper) => {
