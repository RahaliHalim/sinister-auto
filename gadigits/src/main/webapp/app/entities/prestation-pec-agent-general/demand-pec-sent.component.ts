...
@Component({
    selector: "jhi-demand-pec-sent",
    templateUrl: "./demand-pec-sent.component.html"
})
export class DemandPecSentComponent implements OnInit, OnDestroy {
    currentAccount: any;
    demands: DemandPec[];
    error: any;
    success: any;
   ...
   ngOnInit() {
    ...
    loadAll() {
        this.demandPecService.findSentDemands().subscribe(
            (res: ResponseWrapper) => {
