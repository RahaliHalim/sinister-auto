...
@Component({
    selector: "jhi-demand-pec-outstanding",
    templateUrl: "./demand-pec-outstanding.component.html"
})
export class DemandPecOutstandingComponent implements OnInit, OnDestroy {
    currentAccount: any;
    demands: DemandPec[];
    error: any;
    success: any;
    ...
    loadAll() {
        this.demandPecService.findOutstandingDemands().subscribe(
            (res: ResponseWrapper) => {
