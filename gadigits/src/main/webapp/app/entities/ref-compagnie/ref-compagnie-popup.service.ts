        ...
        return new Promise<NgbModalRef>((resolve, reject) => {
            ...
            if (id) {
                this.refCompagnieService.find(id).subscribe((refCompagnie) => {
                    if (refCompagnie.dateCreation) {
                        refCompagnie.dateCreation = {
                            year: refCompagnie.dateCreation.getFullYear(),
                            month: refCompagnie.dateCreation.getMonth() + 1,
                            day: refCompagnie.dateCreation.getDate()
                        };
                    }
