...
@Component( {
    selector: 'jhi-sinister-prestation-closed',
    templateUrl: './sinister-prestation-closed.component.html'
} )
export class SinisterPrestationClosedComponent implements OnInit, OnDestroy {
            ...
            ajax: (dataTablesParameters: any, callback) => {
              that.http
                .post<DataTablesResponse>(
                  'api/view/view-prestation/page/'+StatusSinister.CLOSED,
                        ...
                        buttons: [
                            ...
                            },
                            {
                                ...
                                action: function (e, dt, node, config) {
                                    that.sinisterService.exportprestationToExcel(dt.search(),StatusSinister.CLOSED).subscribe((blob: Blob) => {
                                        let fileName="PrestationClosed.xlsx";
     ...
     */
    loadAll() {
        this.sinisterService.findClosedPrestations().subscribe(
