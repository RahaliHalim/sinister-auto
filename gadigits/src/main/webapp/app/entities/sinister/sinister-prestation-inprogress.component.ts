...
@Component( {
    selector: 'jhi-sinister-prestation-inprogress',
    templateUrl: './sinister-prestation-inprogress.component.html'
} )
export class SinisterPrestationInProgressComponent implements OnInit, OnDestroy {
            ...
            ajax: (dataTablesParameters: any, callback) => {
              that.http
                .post<DataTablesResponse>(
                  'api/view/view-prestation/page/'+StatusSinister.INPROGRESS,
                        ...
                        buttons: [
                            ...
                            },
                            {
                                ...
                                action: function (e, dt, node, config) {
                                    that.sinisterService.exportprestationToExcel(dt.search(),StatusSinister.INPROGRESS).subscribe((blob: Blob) => {
                                        let fileName="PrestationsInprogress.xlsx";
     ...
     */
    loadAll() {
        this.sinisterService.findInProgressPrestations().subscribe(
