...
@Component( {
    selector: 'jhi-sinister-prestation-canceled',
    templateUrl: './sinister-prestation-canceled.component.html'
} )
export class SinisterPrestationCanceledComponent implements OnInit, OnDestroy {
            ...
            ajax: (dataTablesParameters: any, callback) => {
              that.http
                .post<DataTablesResponse>(
                  'api/view/view-prestation/page/'+StatusSinister.CANCELED,
                        ...
                        buttons: [
                            ...
                            },
                            {
                                ...
                                action: function (e, dt, node, config) {
                                    that.sinisterService.exportprestationToExcel(dt.search(),StatusSinister.CANCELED).subscribe((blob: Blob) => {
                                        let fileName="PrestationCanceled.xlsx";
     ...
     */
    loadAll() {
        this.sinisterService.findCanceledPrestations().subscribe(
