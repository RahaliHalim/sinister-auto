...
import com.gaconnecte.auxilium.service.RegionService;
...
public class RegionResourceIntTest {
    ...
    public void createRegion() throws Exception {
        ...
        assertThat(testRegion.getLabel()).isEqualTo(DEFAULT_LABEL);
    ...
    public void updateRegion() throws Exception {
        ...
        assertThat(testRegion.getLabel()).isEqualTo(UPDATED_LABEL);
