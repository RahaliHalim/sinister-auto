...
public class AccountResourceIntTest {
	...
	public void setup() {
		...
		this.restMvc = MockMvcBuilders.standaloneSetup(null).setMessageConverters(httpMessageConverters)
				.build();
		this.restUserMockMvc = MockMvcBuilders.standaloneSetup(null).build();
	}
	...
	public void testRegisterValid() throws Exception {
		ManagedUserVM validUser = new ManagedUserVM(null, // id
				...
				null, null, null, new HashSet<>(Collections.singletonList(AuthoritiesConstants.USER)), "");
		...
		Optional<User> user = userRepository.findOneByLoginIgnoreCase("joe");
...
//            .andExpect(status().isBadRequest());
	...
	public void testRegisterDuplicateLogin() throws Exception {
		...
		ManagedUserVM duplicatedUser = new ManagedUserVM(validUser.getId(), validUser.getLogin(),
				...
				validUser.getLastModifiedBy(), validUser.getLastModifiedDate(), validUser.getIdExterne(),
				validUser.getIdProfil(), validUser.getIdGroup(), validUser.getAuthorities(), "");
...
//            .andExpect(status().is4xxClientError());
	...
	public void testRegisterDuplicateEmail() throws Exception {
		...
		Optional<User> userDup = userRepository.findOneByLoginIgnoreCase("johnjr");
		assertThat(userDup.isPresent()).isFalse();
	}
	...
	public void testRegisterAdminIsIgnored() throws Exception {
		ManagedUserVM validUser = new ManagedUserVM(null, // id
				...
				null, // lastModifiedBy
				null, // lastModifiedDate
				null, null, null, new HashSet<>(Collections.singletonList(AuthoritiesConstants.ADMIN)), "");

		restMvc.perform(post("/api/register").contentType(TestUtil.APPLICATION_JSON_UTF8)
				.content(TestUtil.convertObjectToJsonBytes(validUser))).andExpect(status().isCreated());

		Optional<User> userDup = userRepository.findOneByLoginIgnoreCase("badguy");
	...
	public void testChangePassword() throws Exception {
		...
		restMvc.perform(post("/api/account/change_password").content("new password")).andExpect(status().isOk());
	...
	public void testChangePasswordTooSmall() throws Exception {
		...
		restMvc.perform(post("/api/account/change_password").content("new")).andExpect(status().isBadRequest());
	...
	public void testRequestPasswordReset() throws Exception {
		...
		restMvc.perform(post("/api/account/reset_password/init").content("password-reset@example.com"))
				.andExpect(status().isOk());
	}

	@Test
	public void testRequestPasswordResetWrongEmail() throws Exception {
		restMvc.perform(post("/api/account/reset_password/init").content("password-reset-wrong-email@example.com"))
				.andExpect(status().isBadRequest());
	}
	...
	public void testFinishPasswordResetTooSmall() throws Exception {
		...
		restMvc.perform(post("/api/account/reset_password/finish").contentType(TestUtil.APPLICATION_JSON_UTF8)
				.content(TestUtil.convertObjectToJsonBytes(null))).andExpect(status().isBadRequest());

		User updatedUser = userRepository.findOneByLoginIgnoreCase(user.getLogin()).orElse(null);
	}

	private AbstractBooleanAssert<?> assertThat(boolean b) {
