...
public class RefTypeServiceResourceIntTest {
    ...
    @Autowired
    private RefTypeServiceMapper refTypeServiceMapper;
    ...
    public void setup() {
        ...
        RefTypeServiceResource refTypeServiceResource = new RefTypeServiceResource(refTypeServiceService, null);
    ...
    public void createRefTypeService() throws Exception {
        ...
        RefTypeServiceDTO refTypeServiceDTO = refTypeServiceMapper.toDto(refTypeService);
        restRefTypeServiceMockMvc.perform(post("/api/ref-type-services")
            .contentType(TestUtil.APPLICATION_JSON_UTF8)
            .content(TestUtil.convertObjectToJsonBytes(refTypeServiceDTO)))
    ...
    public void updateRefTypeService() throws Exception {
        ...
        updatedRefTypeService
            .nom(UPDATED_NOM);
        RefTypeServiceDTO refTypeServiceDTO = refTypeServiceMapper.toDto(updatedRefTypeService);
    ...
    public void dtoEqualsVerifier() throws Exception {
        TestUtil.equalsVerifier(RefTypeServiceDTO.class);
        RefTypeServiceDTO refTypeServiceDTO1 = new RefTypeServiceDTO();
        refTypeServiceDTO1.setId(1L);
        RefTypeServiceDTO refTypeServiceDTO2 = new RefTypeServiceDTO();
        assertThat(refTypeServiceDTO1).isNotEqualTo(refTypeServiceDTO2);
        refTypeServiceDTO2.setId(refTypeServiceDTO1.getId());
        assertThat(refTypeServiceDTO1).isEqualTo(refTypeServiceDTO2);
        refTypeServiceDTO2.setId(2L);
        assertThat(refTypeServiceDTO1).isNotEqualTo(refTypeServiceDTO2);
        refTypeServiceDTO1.setId(null);
        assertThat(refTypeServiceDTO1).isNotEqualTo(refTypeServiceDTO2);
    }
    ...
    public void testEntityFromId() {
        assertThat(refTypeServiceMapper.fromId(42L).getId()).isEqualTo(42);
        assertThat(refTypeServiceMapper.fromId(null)).isNull();
    }
}
